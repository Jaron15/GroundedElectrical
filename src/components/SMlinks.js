...
<a href="https://www.facebook.com/groundedinAZ" target="_blank" className="text-2xl border border-gold rounded-full p-2 hover:opacity-90 text-blue-500 hover:text-blue-500 hover:shadow-[0_0_20px_#ffd277] transition ease-in-out duration-300">
  <FaFacebookF />
</a>
</div>
  )
